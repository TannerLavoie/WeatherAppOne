...
export const Rain = () => (
  ...
  <g transform="translate(16,-2)" filter="url(#blur)">
    <g className="am-weather-sun" transform="translate(0,16)">
      <line transform="translate(0,9)" y2="3" stroke="#ffa500" strokeLinecap="round" strokeWidth="2" fill="none" />
    ...
    <g className="am-weather-cloud-3">
      <path transform="translate(-20,-11)"
        ...
        fill="#57a0ee" stroke="#fff" stroke-linejoin="round" strokeWidth="1.2" />
    </g>
    <g className="am-weather-rainy-3" transform="translate(-20,-10) rotate(10,-247.39,200.17)" fill="none" stroke="#91c0f8" stroke-dasharray="4, 4" strokeLinecap="round"
      strokeWidth="2">
